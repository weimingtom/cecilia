...
static int populate_methods(PyObject *klass, PyObject *dict, PyMethodDef *methods)
{
    if (!methods)
	{
		return 0;
...
static int make_class(PyObject **klass, PyObject *base,
...
static char Exception__doc__[] = "Common base class for all exceptions.";

static PyObject *Exception__init__(PyObject *self, PyObject *args)
{
    int status;
...
static PyObject *Exception__str__(PyObject *self, PyObject *args)
{
    PyObject *out;
...
static PyObject *Exception__getitem__(PyObject *self, PyObject *args)
{
    PyObject *out;
    PyObject *index;
...
static PyMethodDef Exception_methods[] = {
...
static int make_Exception(char *modulename)
{
    PyObject *dict = PyDict_New();
    PyObject *str = NULL;
    PyObject *name = NULL;
...
static char StandardError__doc__[] = "Base class for all standard Python exceptions.";

static char TypeError__doc__[] = "Inappropriate argument type.";

static char StopIteration__doc__[] = "Signal the end from iterator.next().";

static char SystemExit__doc__[] = "Request to exit from the interpreter.";


static PyObject *SystemExit__init__(PyObject *self, PyObject *args)
{
    PyObject *code;
    int status;
...
static char KeyboardInterrupt__doc__[] = "Program interrupted by user.";

static char ImportError__doc__[] =
	"Import can't find module, or can't find name in module.";

static char EnvironmentError__doc__[] = "Base class for I/O related errors.";


static PyObject *EnvironmentError__init__(PyObject *self, PyObject *args)
{
    PyObject *item0 = NULL;
    PyObject *item1 = NULL;
    PyObject *item2 = NULL;
...
static PyObject *EnvironmentError__str__(PyObject *self, PyObject *args)
{
...
static char IOError__doc__[] = "I/O operation failed.";
...
static char RuntimeError__doc__[] = "Unspecified run-time error.";

static char NotImplementedError__doc__[] =
	"Method or function hasn't been implemented yet.";

static char NameError__doc__[] = "Name not found globally.";

static char UnboundLocalError__doc__[] =
	"Local name referenced but not bound to a value.";

static char AttributeError__doc__[] = "Attribute not found.";

static char SyntaxError__doc__[] = "Invalid syntax.";

static int SyntaxError__classinit__(PyObject *klass)
{
    int retval = 0;
...
static PyObject *SyntaxError__init__(PyObject *self, PyObject *args)
{
    PyObject *rtnval = NULL;
    int lenargs;
...
static PyObject *SyntaxError__str__(PyObject *self, PyObject *args)
{
    PyObject *msg;
    PyObject *str;
...
static char AssertionError__doc__[] = "Assertion failed.";

static char LookupError__doc__[] = "Base class for lookup errors.";

static char IndexError__doc__[] = "Sequence index out of range.";

static char KeyError__doc__[] = "Mapping key not found.";

static char ArithmeticError__doc__[] = "Base class for arithmetic errors.";

static char OverflowError__doc__[] = "Result too large to be represented.";

static char ZeroDivisionError__doc__[] =
	"Second argument to a division or modulo operation was zero.";

static char FloatingPointError__doc__[] = "Floating point operation failed.";

static char ValueError__doc__[] = "Inappropriate argument value (of correct type).";

static char UnicodeError__doc__[] = "Unicode related error.";

static char SystemError__doc__[] = 
	"Internal error in the Python interpreter.\n"
	"\n"
	"Please report this to the Python maintainer, along with the traceback,\n"
	"the Python version, and the hardware/OS platform and version.";

static char ReferenceError__doc__[] = "Weak ref proxy used after referent went away.";

static char MemoryError__doc__[] = "Out of memory.";

static char IndentationError__doc__[] = "Improper indentation.";

static char TabError__doc__[] = "Improper mixture of spaces and tabs.";

static char Warning__doc__[] = "Base class for warning categories.";

static char UserWarning__doc__[] = "Base class for warnings generated by user code.";

static char DeprecationWarning__doc__[] =
	"Base class for warnings about deprecated features.";

static char SyntaxWarning__doc__[] = "Base class for warnings about dubious syntax.";

static char OverflowWarning__doc__[] = "Base class for warnings about numeric overflow.";

static char RuntimeWarning__doc__[] =
...
static struct {
	...
	{"StopIteration", &PyExc_StopIteration, &PyExc_Exception, StopIteration__doc__},
	{"StandardError", &PyExc_StandardError, &PyExc_Exception, StandardError__doc__},
	{"TypeError", &PyExc_TypeError, 0, TypeError__doc__},
	{"SystemExit", &PyExc_SystemExit, &PyExc_Exception, SystemExit__doc__, SystemExit_methods},
	...
	{"UnboundLocalError", &PyExc_UnboundLocalError, &PyExc_NameError, UnboundLocalError__doc__},
	{"AttributeError",     &PyExc_AttributeError, 0, AttributeError__doc__},
	{"SyntaxError",        &PyExc_SyntaxError,    0, SyntaxError__doc__, SyntaxError_methods, SyntaxError__classinit__},
	{"IndentationError",   &PyExc_IndentationError, &PyExc_SyntaxError, IndentationError__doc__},
	{"TabError",   &PyExc_TabError, &PyExc_IndentationError, TabError__doc__},
	{"AssertionError",     &PyExc_AssertionError, 0, AssertionError__doc__},
	{"LookupError",        &PyExc_LookupError,    0, LookupError__doc__},
	{"IndexError",         &PyExc_IndexError,     &PyExc_LookupError, IndexError__doc__},
	{"KeyError",           &PyExc_KeyError,       &PyExc_LookupError, KeyError__doc__},
	{"ArithmeticError",    &PyExc_ArithmeticError, 0, ArithmeticError__doc__},
	{"OverflowError",      &PyExc_OverflowError,     &PyExc_ArithmeticError, OverflowError__doc__},
	{"ZeroDivisionError",  &PyExc_ZeroDivisionError,  &PyExc_ArithmeticError, ZeroDivisionError__doc__},
	{"FloatingPointError", &PyExc_FloatingPointError, &PyExc_ArithmeticError, FloatingPointError__doc__},
	...
	{"DeprecationWarning", &PyExc_DeprecationWarning, &PyExc_Warning, DeprecationWarning__doc__},
	{"SyntaxWarning", &PyExc_SyntaxWarning, &PyExc_Warning, SyntaxWarning__doc__},
	{"OverflowWarning", &PyExc_OverflowWarning, &PyExc_Warning, OverflowWarning__doc__},
	{"RuntimeWarning", &PyExc_RuntimeWarning, &PyExc_Warning, RuntimeWarning__doc__},
	{NULL}
};
...
err:
    ...
    for (i=1; exctable[i].name; i++) 
	{
		...
		strcpy(cname, modulename);
		strcat(cname, ".");
		strcat(cname, exctable[i].name);
