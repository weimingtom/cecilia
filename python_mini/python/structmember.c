...
PyObject *PyMember_Get(char *addr, struct memberlist *mlist, char *name)
{
	struct memberlist *l;
...
PyObject *PyMember_GetOne(char *addr, PyMemberDef *l)
{
	PyObject *v;
...
int PyMember_Set(char *addr, struct memberlist *mlist, char *name, PyObject *v)
{
	struct memberlist *l;
