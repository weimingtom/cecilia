...
static PyObject *lock_PyThread_release_lock(lockobject *self, PyObject *args)
{
...
static PyObject *lock_locked_lock(lockobject *self, PyObject *args)
{
	if (!PyArg_NoArgs(args))
	{
		return NULL;
...
static PyObject *lock_getattr(lockobject *self, char *name)
{
...
static PyObject *thread_PyThread_exit_thread(PyObject *self, PyObject *args)
{
	if (!PyArg_NoArgs(args))
	{
		return NULL;
...
static PyObject *thread_get_ident(PyObject *self, PyObject *args)
{
	long ident;
	if (!PyArg_NoArgs(args))
	{
