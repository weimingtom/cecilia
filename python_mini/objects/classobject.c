...
int PyClass_IsSubclass(PyObject *class, PyObject *base)
{
	int i, n;
	PyClassObject *cp;
	if (class == base)
...
static char *getclassname(PyObject *class)
{
	PyObject *name;
...
static PyObject *instancemethod_descr_get(PyObject *meth, PyObject *obj, PyObject *class)
{
