...
static PyObject *func_get_dict(PyFunctionObject *op)
{
	if (restricted())
	{
		return NULL;
...
static PyObject *func_get_code(PyFunctionObject *op)
{
	if (restricted())
	{
		return NULL;
...
static PyObject *func_get_defaults(PyFunctionObject *op)
{
	if (restricted())
	{
		return NULL;
...
static PyObject *function_call(PyObject *func, PyObject *arg, PyObject *kw)
{
	PyObject *result;
	PyObject *argdefs;
	PyObject **d, **k;
