...
PyObject *PySymtableEntry_New(struct symtable *st, char *name, int type, int lineno)
{
...
static PyObject *ste_repr(PySymtableEntryObject *ste)
{
	char buf[256];
...
static void ste_dealloc(PySymtableEntryObject *ste)
{
	ste->ste_table = NULL;
