...
namespace cecilia 
{
	public partical class cecilia 
	{
		...
		public static node
		PyParser_ParseString(CharPtr s, grammar g, int start, perrdetail err_ret)
		{
			return PyParser_ParseStringFlags(s, g, start, err_ret, 0);
		}

		public static node 
		PyParser_ParseStringFlags(CharPtr s, grammar g, int start,
		...
		public static node 
		PyParser_ParseFile(FILE fp, CharPtr filename, grammar g, int start,
		...
		public static node 
		PyParser_ParseFileFlags(FILE fp, CharPtr filename, grammar g, int start,
		...
		private static string yield_msg =
		"%s:%d: Warning: 'yield' will become a reserved keyword in the future\n";

		private static node 
		parsetok(tok_state tok, grammar g, int start, perrdetail err_ret,
			 int flags)
		{
			parser_state *ps;
			node *n;
		...
		private static void
		initerr(perrdetail err_ret, CharPtr filename)
		{
			err_ret->error = E_OK;
