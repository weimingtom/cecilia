...
namespace cecilia 
{
	public partical class cecilia 
	{
		...
		public static tok_state
		PyTokenizer_FromString(CharPtr str)
		{
		...
		public static tok_state
		PyTokenizer_FromFile(FILE fp, CharPtr ps1, CharPtr ps2)
		{
			struct tok_state *tok = tok_new();
			if (tok == NULL)
				return NULL;
		...
		public static void
		PyTokenizer_Free(tok_state tok)
		{
		...
		public static int
		PyTokenizer_Get(struct tok_state tok, ref CharPtr p_start,
				ref CharPtr p_end)
		{
			register int c;
			int blankline;
		...
		public static void
		tok_dump(int type, CharPtr start, CharPtr end)
		{
