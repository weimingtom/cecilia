...
static PyObject *complex_subtype_from_c_complex(PyTypeObject *type, Py_complex cval)
{
	PyObject *op;
...
static PyObject *complex_subtype_from_doubles(PyTypeObject *type, double real, double imag)
{
	Py_complex c;
	c.real = real;
	c.imag = imag;
...
static void complex_to_buf(char *buf, int bufsz, PyComplexObject *v, int precision)
{
	if (v->cval.real == 0.)
	{
...
static PyObject *complex_str(PyComplexObject *v)
{
	char buf[100];
...
static PyObject *complex_classic_div(PyComplexObject *v, PyComplexObject *w)
{
	Py_complex quot;
...
static PyObject *complex_int_div(PyComplexObject *v, PyComplexObject *w)
{
	PyObject *t, *r;
...
static PyNumberMethods complex_as_number = {
	...
	0,					
	0,					
	(coercion)complex_coerce,		
	(unaryfunc)complex_int,			
	(unaryfunc)complex_long,		
	(unaryfunc)complex_float,		
	0,					
	0,					
	0,					
	0,					
