...
static PyObject *meth_get__name__(PyCFunctionObject *m, void *closure)
{
...
static PyObject *meth_get__self__(PyCFunctionObject *m, void *closure)
{
	PyObject *self;
...
PyObject *Py_FindMethodInChain(PyMethodChain *chain, PyObject *self, char *name)
{
