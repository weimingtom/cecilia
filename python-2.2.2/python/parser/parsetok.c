...
node *PyParser_ParseString(char *s, grammar *g, int start, perrdetail *err_ret)
{
	return PyParser_ParseStringFlags(s, g, start, err_ret, 0);
}

node *PyParser_ParseStringFlags(char *s, grammar *g, int start, 
...
node *PyParser_ParseFile(FILE *fp, char *filename, grammar *g, int start,
...
node *PyParser_ParseFileFlags(FILE *fp, char *filename, grammar *g, int start,
...
static node *parsetok(struct tok_state *tok, grammar *g, int start, perrdetail *err_ret, int flags)
{
	parser_state *ps;
	node *n;
	int started = 0;
